...
import { ArrowRight, Car, MapPin, Star, Wrench } from "lucide-react"
        ...
        <section className="w-full py-12 md:py-24 lg:py-32 xl:py-48">
          <div className="container px-4 md:px-6">
            <div className="grid gap-6 lg:grid-cols-[1fr_400px] lg:gap-12 xl:grid-cols-[1fr_600px]">
              <div className="flex flex-col justify-center space-y-4">
                <div className="space-y-2">
                  ...
                  <p className="max-w-[600px] text-muted-foreground md:text-xl">
                    Connect with nearby mechanics and tow trucks instantly. Get help when you need it most, with
              ...
              <Image
                src="4 Simple Ways to Prevent Parking Lot Accidents - Cars Fellow.jpeg"
                width={550}
                height={550}
                alt="Car assistance illustration"
          ...
          <div className="container px-4 md:px-6">
            ...
            <div className="mx-auto grid max-w-5xl grid-cols-1 gap-6 py-12 md:grid-cols-3">
              ...
              <div className="flex flex-col items-center space-y-2 rounded-lg border p-6 shadow-sm">
                ...
                <p className="text-center text-muted-foreground">
                  All mechanics and tow trucks are vetted and verified
                </p>
              </div>
              <div className="flex flex-col items-center space-y-2 rounded-lg border p-6 shadow-sm">
                <div className="rounded-full bg-primary/10 p-3">
          ...
          <div className="container px-4 md:px-6">
            ...
            <div className="mx-auto grid max-w-5xl grid-cols-1 gap-8 py-12 md:grid-cols-3">
              <div className="flex flex-col items-center space-y-2">
                ...
                <h3 className="text-xl font-bold">Request Help</h3>
                <p className="text-center text-muted-foreground">
              ...
              <div className="flex flex-col items-center space-y-2">
                ...
                <p className="text-center text-muted-foreground">
                  We'll match you with nearby available service providers
                </p>
              </div>
              <div className="flex flex-col items-center space-y-2">
                <div className="flex h-12 w-12 items-center justify-center rounded-full bg-primary text-xl font-bold text-primary-foreground">
                ...
                <h3 className="text-xl font-bold">Problem Solved</h3>
                <p className="text-center text-muted-foreground">
        ...
        <section id="pricing" className="w-full py-12 md:py-24 lg:py-32 bg-muted/50">
          <div className="container px-4 md:px-6">
            ...
            <div className="mx-auto grid max-w-5xl grid-cols-1 gap-6 py-12 md:grid-cols-2">
              <div className="flex flex-col items-center space-y-2 rounded-lg border p-6 shadow-sm">
                <h3 className="text-xl font-bold">For Car Owners</h3>
                <p className="text-center text-muted-foreground mb-4">Free to sign up and request assistance</p>
                <ul className="space-y-2 text-left w-full">
                  ...
                  <li className="flex items-center">
                    ...
                    <span>Pay only for services rendered</span>
                  </li>
                  <li className="flex items-center">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
              ...
              <div className="flex flex-col items-center space-y-2 rounded-lg border p-6 shadow-sm">
                ...
                <p className="text-center text-muted-foreground mb-4">Grow your business with our platform</p>
                <ul className="space-y-2 text-left w-full">
                  <li className="flex items-center">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                    ...
                    <span>10% platform fee on completed services</span>
                  </li>
                  <li className="flex items-center">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
        ...
        <section className="w-full py-12 md:py-24 lg:py-32">
          <div className="container px-4 md:px-6">
            <div className="grid gap-6 lg:grid-cols-2 lg:gap-12">
              <div className="flex flex-col justify-center space-y-4">
                <div className="space-y-2">
                  <h2 className="text-3xl font-bold tracking-tighter md:text-4xl/tight">Join our growing network</h2>
